<?php
  ...
  if(!empty($_POST)){
    $id = $_POST['id'];
    $alimento = $_POST['salada'];
    if($alimento != ""){
      $SQL_select = "SELECT * FROM pots_salad WHERE id_pot='$id' AND name='$alimento'";
      ...
      if(mysqli_num_rows($result_select) > 0){
        ...
        $SQL_rice = "INSERT INTO pots_salad(id_pot, name) VALUES ('$id','$alimento')";
