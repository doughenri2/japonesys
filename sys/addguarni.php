<?php
  ...
  if(!empty($_POST)){
    $id = $_POST['id'];
    $alimento = $_POST['guarni'];
    if($alimento != ""){
      $SQL_select = "SELECT * FROM pots_garrison WHERE id_pot='$id' AND name='$alimento'";
      ...
      if(mysqli_num_rows($result_select) > 0){
        ...
        $SQL_rice = "INSERT INTO pots_garrison(id_pot, name) VALUES ('$id','$alimento')";
