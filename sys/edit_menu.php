...
<div class="wrapper">
  ...
  $id = anti_injection($_GET['i']);

  $SQL_pots = "SELECT *, DATE_FORMAT(entry_date, '%d/%m/%Y') as entry_date  FROM pots WHERE id_user='".$_SESSION['id_user']."' AND id='".$id."' LIMIT 1";
  $results = mysqli_query($con, $SQL_pots) or die(mysqli_error($con));
  $row_pot = mysqli_fetch_assoc($results);
  ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo "#$id"?>
        <small>Marmita <?php echo "#$id"?> </small>
      </h1>
      <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6" >
                    ...
                    <div class="form-group has-feedback" id="div_rice">
                      <?php
                      $SQL_rice = "SELECT * FROM pots_rice WHERE id_pot='".$id."'";
                ...
                <div class="col-md-12">
                  <div class="col-md-6" >
                    ...
                    <div class="form-group has-feedback" id="div_bean">
                      <?php
                      $SQL_rice = "SELECT * FROM pots_beans WHERE id_pot='".$id."'";
                      $result_rice = mysqli_query($con, $SQL_rice) or die(mysqli_error($con));
                      while($row = mysqli_fetch_assoc($result_rice)){
                      ?>
                ...
                <div class="col-md-12">
                  <div class="col-md-6" >
                    ...
                    <div class="form-group has-feedback" id="div_mixture">
                      <?php
                      $SQL_rice = "SELECT * FROM pots_mixture WHERE id_pot='".$id."'";
                      $result_rice = mysqli_query($con, $SQL_rice) or die(mysqli_error($con));
                      while($row = mysqli_fetch_assoc($result_rice)){
                      ?>
                ...
                <div class="col-md-12">
                  <div class="col-md-6" >
                    ...
                    <div class="form-group has-feedback" id="div_garrison">
                      <?php
                      $SQL_rice = "SELECT * FROM pots_garrison WHERE id_pot='".$id."'";
                      $result_rice = mysqli_query($con, $SQL_rice) or die(mysqli_error($con));
                      while($row = mysqli_fetch_assoc($result_rice)){
                      ?>
                ...
                <div class="col-md-12">
                  <div class="col-md-6" >
                    ...
                    <div class="form-group has-feedback" id="div_salad">
                      <?php
                      $SQL_rice = "SELECT * FROM pots_salad WHERE id_pot='".$id."'";
                      $result_rice = mysqli_query($con, $SQL_rice) or die(mysqli_error($con));
                      while($row = mysqli_fetch_assoc($result_rice)){
                      ?>
